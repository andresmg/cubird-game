class Board {
    ...
    nextRoundCurtain(getCurrentPlayerId) {
        ...
        } else if (getCurrentPlayerId === "player1" && this.playersNames[0] !== "") {
            document.querySelector(".next-round h1").innerText = `${this.playersNames[1]}'s turn`
        } else if (getCurrentPlayerId === "player2" && this.playersNames[1] === "") {
            document.querySelector(".next-round h1").innerText = `player 1's turn`
        } else if (getCurrentPlayerId === "player1" && this.playersNames[0] !== "") {
            document.querySelector(".next-round h1").innerText = `${this.playersNames[0]}'s turn`
        }
